...
public class VendingMachineAACmdFactory {
    private static byte[] allCmd(byte cmd, byte frameLength, String cabinetAddress, String data) {
        ...
        cabinetAddress = ByteUtil.hexString(cabinetAddress, 1);
        String notHeaderAndTailStr = cabinetAddress + number + strFrameLength + command + data;
        ...
        CmdBean.Builder builder = CmdBean.newBuilder()
                ...
                .setCabinetAddress(cabinetAddress)
                .setCommand(command)
                .setNumber(number)
                .setCRC(cRc)
     ...
     * B6     ——  校验码
     */
    public static byte[] responseFrame(String cabinetAddress, String data) {
        return allCmd(VendingMachineAAProtocol.RESPONSE_FRAME_HTS, VendingMachineAAProtocol.SIX_LEN, cabinetAddress, data);
    }
     ...
     * B6     ——  校验码
     */
    public static byte[] testingSingleDrivers(String cabinetAddress, String data) {
        return allCmd(VendingMachineAAProtocol.TESTING_SINGLE_DRIVER_HTS, VendingMachineAAProtocol.SIX_LEN, cabinetAddress, data);
    }
     ...
     * B5     ——  校验码
     */
    public static byte[] testingCabinetDrive(String cabinetAddress) {
     ...
     * B5     ——  校验码
     */
    public static byte[] cargoTrackScanning(String cabinetAddress) {
     ...
     * B6     ——  校验码
     */
    public static byte[] sellingGoods(String cabinetAddress, String data) {
     ...
     * B5     ——  校验码
     */
    public static byte[] slaveStateQuery(String cabinetAddress) {
     ...
     * B8     ——  校验码
     */
    public static byte[] setTemperature(String cabinetAddress, String data) {
     ...
     * B6     ——  校验码
     */
    public static byte[] temperatureQuery(String cabinetAddress, String data) {
     ...
     * B5     ——  校验码
     */
    public static byte[] firmwareVersionQuery(String cabinetAddress) {
     ...
     * B6     ——  校验码
     */
    public static byte[] photometricControl(String cabinetAddress, String data) {
